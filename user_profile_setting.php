...
<!-- End of Sidebar -->
    ...
    if(isset($_POST['update'])){
        ...
        $u_bio = $_POST['u_bio'];
            ...
            $update_user = "update al_user set u_name = '$u_name',u_email = '$u_email',u_pass = '$u_pass',u_pic = '$u_pic',u_dob= '$u_dob',u_country = '$u_country',u_city = '$u_city',u_mobile = '$u_mobile',u_bio = '$u_bio' where u_id = $id";
