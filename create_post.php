...
<!-- End of Sidebar -->
    ...
    if(isset($_POST['publish'])){
        ...
        $p_content = mysqli_real_escape_string($con, $_POST['p_content']);
        ...
        $query = "INSERT INTO al_post (p_title, p_description, p_content, p_pic, p_date, p_user) 
        VALUES ('$p_title', '$p_description', '$p_content', '$p_pic', '$p_date', '$p_id')";
