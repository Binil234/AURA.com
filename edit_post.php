...
<!-- End of Sidebar -->
        ...
        <div class="row post">
         <div class="col-12">
            ...
            if(isset($_GET['edit_post'])){
                ...
                $query = "select * from al_post where p_id = $post_id";
            ...
            ?>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            ...
                            <img src="../Post/<?php echo $p_pic?>" width="100" height="100" alt="">
                        </div>
                        <br>
                    <div class="form-group">
     ...
     <?php
       if (isset($_POST['update'])) {
        ...
        // Move uploaded file
        move_uploaded_file($p_pic_temp, "../Post/$p_pic");
    
        // Use prepared statement for updating the post
        $update_post = $con->prepare("
            UPDATE al_post 
            SET 
                p_title = ?, 
                p_description = ?, 
            ...
            WHERE 
                p_id = ?
        ");
        $update_post->bind_param("ssssii", $p_title, $p_description, $p_content, $p_pic, $p_user, $post_id);
        ...
        if ($update_post->execute()) {
            ...
            echo "Error updating post: " . $update_post->error;
        }
    }
